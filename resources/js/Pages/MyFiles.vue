<template>
    ...
    <AuthenticatedLayout>
        <nav class="flex items-center justify-between p-1 mb-3">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                >
                    ...
                    <Layout class="w-4 h-4 mx-4" v-if="!ans.parent_id" />
                    <!-- layout view -->
                    <!-- list view -->
        ...
        <div style="height: 99vh">
            ...
            >
                <!-- List view content -->
                <!-- display  data here in list view format -->
            ...
            >
                <!-- Grid view content -->
                <!--  display  data here in grid view format -->
                <!-- grid view  -->
                <div
                    class="flex-1 overflow-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-9 gap-4"
                >
                    <!-- Loop through files and create a card for each file -->
                    <div
                        v-for="file of allFiles.data"
                        :key="file.id"
                        @click="($event) => toggleFileSelect(file)"
                        @dblclick="openFolder(file)"
                        class="border border-gray-300 hover:bg-blue-100 cursor-pointer"
                    >
                        <div class="p-4">
                            <!-- Checkbox -->
                            <Checkbox
                            ...
                            >
                                <svg
                                    ...
                                    class="w-6 h-6"
                                >
                                    <!-- Favourite icon when not favorited -->
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"
                            ...
                            <div class="flex items-center">
                                <FileIcon :file="file" class="w-8 h-8 mr-2" />
                                <span
                            ...
                            <!-- Display Path, Owner, Last Modified, and Size (if needed) -->
                            <div class="text-sm font-medium text-gray-900">
                                <span v-if="search">{{ file.path }}</span>
                                <br />
                                <span class="">{{ file.owner }}</span>
                                <br />
                                <span class="">{{ file.updated_at }}</span>
                                <br />
                                <span>{{ file.size }}</span>
                            </div>
                        </div>
...
import ListView from "@/Pages/Icons/ListView.vue";
import Gridlayout from "@/Components/app/Gridlayout.vue";
